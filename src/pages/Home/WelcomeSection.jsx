			...
			>
				<div className={styles.imageWrapper}>
					<img
						...
						src={img1}
						alt="High-rise residential engineering project by ASM Consulting Engineers"
					/>
				</div>
				<div className={styles.imageWrapper}>
					<img
						className={styles.welcomeSectionImage}
						src={img2}
						alt="Modern mid-rise building project supported by ASM Consulting Engineers"
					/>
				</div>
				<div className={styles.imageWrapper}>
					<img
						className={styles.welcomeSectionImage}
						src={img3}
						alt="Construction and site engineering project by ASM Consulting Engineers"
					/>
				</div>
				<div className={styles.imageWrapper}>
					<img
						className={styles.welcomeSectionImage}
						src={img4}
						alt="Rear view of engineered building design by ASM Consulting Engineers"
					/>
				</div>
				<div className={styles.imageWrapper}>
					<img
						className={styles.welcomeSectionImage}
						src={img5}
						alt="Architectural rendering coordinated with ASM Consulting Engineers"
					/>
				</div>
			</Carousel>
