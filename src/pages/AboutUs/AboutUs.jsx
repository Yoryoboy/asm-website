	...
	return (
		<>
			<Seo
				...
				description="Learn about ASM Consulting Engineers, a Miami-based structural and civil engineering firm with expertise in BIM, inspections, design management, and technical consulting."
				path="/about"
				structuredData={[
					createWebPageSchema({
						title: "About ASM Consulting Engineers",
					...
					<div className={styles.aboutUsContainer}>
						<div className={styles.introBlock}>
							...
							<p className={styles.lead}>
								ASM is a Florida-based consulting engineering firm established
								in 2009 by Sina Malek, P.E., a licensed Professional Engineer
								with over 25 years of experience in structural and civil
								engineering design, inspection, and construction support.
							</p>
							<p>
						...
						<div className={styles.featureGrid}>
							<article className={styles.featureCard}>
								...
								<p>
									ASM combines engineering expertise with advanced BIM
									technology to improve interdisciplinary coordination, reduce
									construction conflicts, and support efficient project delivery
							...
							<article className={styles.featureCard}>
								...
								<p>
									...
									BIM-enabled efficiency to help clients meet cost and
									performance objectives without compromising safety or quality.
								</p>
							</article>
						</div>
						...
						<div className={styles.contentGrid}>
							...
							<section className={styles.contentCard}>
								...
								<p>
									...
									landscape, including specialty mid-rise and high-rise
									structures for both private and public sectors.
								</p>
								<ul>
